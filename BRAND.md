...
- **Fundos escuros:** aplicar inversão CSS (`filter: brightness(0) invert(1)`) ou usar versão oficial clara.
...
**Fotos disponíveis (Bento Gonçalves):**
- `class-group.jpg` — grupo de alunos
- `easter-event.jpg` — evento Páscoa (Toddler)
- `hug-trio.jpg` — abraço entre crianças
- `nursery-drawing.jpg` — Nursery desenhando
- `toddler-swing.jpg` — balanço
- `welcome-entrance.jpg` — entrada da escola

---

## 7. Histórico de mudanças

- **2026-05-25** — Documento criado consolidando manual oficial + sync com Caxias.
- BG migrado de SVG hand-drawn (`logo-modern.svg`, `mascot-bear.svg`, `seal-duplo-diploma.svg`) pra kit oficial PNG copiado de Caxias.
